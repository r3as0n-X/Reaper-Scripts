...
Mode = Shape:new(0,0,0,100,false,0,0,0,2,"Mode :", 16, 235,235,235,100)

mode_area = Shape:new(255,255,0,0,false,173,308,87,60)

Normal = Shape:new(0,0,0,100,false,mode_area.xywh[1] - 20, mode_area.xywh[2] - 20,0,2,"Normal", 16, 200,200,200,100)
Normal_C = Shape:new(200,200,200,-1,false,mode_area.xywh[1] + 30,mode_area.xywh[2] -20,6,0)
Docked = Shape:new(0,0,0,100,false,mode_area.xywh[1] - 20,mode_area.xywh[2],0,2,"Docked", 16, 200,200,200,100)
Docked_C = Shape:new(200,200,200,-1,false,mode_area.xywh[1] + 30,mode_area.xywh[2],6,0)
Hidden = Shape:new(0,0,0,100,false,mode_area.xywh[1] - 20,mode_area.xywh[2] + 20,0,2,"Hidden", 16, 200,200,200,100)
...
Mode:place("center", 0, "top", help1.xywh[4] + help2.xywh[4] + help3.xywh[4] + 180)
